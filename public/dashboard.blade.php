...
<!-- PAGE-HEADER END -->
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="mt-2">
                            ...
                            <h2 class="mb-0 number-font">{{$salesCount}}</h2>
                        </div>
                        <div class="ms-auto">
                    ...
                    <span class="text-muted fs-12"><span class="text-secondary"><i
                                class="fe fe-arrow-up-circle  text-secondary"></i> {{$salesWeekCount}}</span>
                        This week</span>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="mt-2">
                            ...
                            <h2 class="mb-0 number-font">{{$visitsNumberCount}}</h2>
                        </div>
                        <div class="ms-auto">
                            <div class="chart-wrapper mt-1">
                    ...
                    <span class="text-muted fs-12"><span class="text-pink"><i
                                class="fe fe-arrow-up-circle text-pink"></i>{{$visitsWeekCount}}</span>
                        This Week</span>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="mt-2">
                            <h6 class="">Total Outlets</h6>
                            <h2 class="mb-0 number-font">{{$outletsCount}}</h2>
                        </div>
                        <div class="ms-auto">
                            <div class="chart-wrapper mt-1">
                    ...
                    <span class="text-muted fs-12"><span class="text-green"><i
                                class="fe fe-arrow-up-circle text-green"></i> {{$outletsWeekCount}}</span>
                        This week</span>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="mt-2">
                            ...
                            <h2 class="mb-0 number-font">{{$productsNumberCount}}</h2>
                        </div>
                        <div class="ms-auto">
                            <div class="chart-wrapper mt-1">
                                <canvas id="costchart"
                    ...
                    <span class="text-muted fs-12"><span class="text-warning"><i
                                class="fe fe-arrow-up-circle text-warning"></i>{{$productsWeekCount}}</span>
                        This Week</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body pb-0 bg-recentorder">
                    <h3 class="card-title text-white">Recent Visits</h3>
                    <div class="chartjs-wrapper-demo">
                ...
                <div class="card-body">
                    <div class="d-flex mb-4 mt-3">
                        ...
                        <div class="">
                            <h6 class="mb-1 fw-semibold">Visits</h6>
                            <p class="fw-normal fs-12"> <span class="text-success">This Week</span>
                                (Last 7 days) </p>
                        </div>
                        <div class=" ms-auto my-auto">
                            <p class="fw-bold fs-20"> {{$visitsWeekCount}} </p>
                        </div>
                    </div>
                    <div class="d-flex">
                        ...
                        <div class="">
                            <h6 class="mb-1 fw-semibold">Sales</h6>
                            <p class="fw-normal fs-12"> <span class="text-danger">This Week</span>
                                (Last 7 days) </p>
                        </div>
                        <div class=" ms-auto my-auto">
                            <p class="fw-bold fs-20 mb-0">{{$salesWeekCount}} </p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @php
    // Determine the row counts
    // $outletsTableCount = count($outlets);
    // $salesTableCount = count($sales);
    $outletsTableCount = count($outlets) > 0 ? count($outlets) : 1;
    $salesTableCount = count($sales) > 0 ? count($sales) : 1;
    // Calculate the difference
    $differenceOutletsSales = abs($outletsTableCount - $salesTableCount);
    @endphp
...
<div class="row">
                ...
                <div class="table-responsive">
                    <table class="table border text-nowrap text-md-nowrap table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            <td>{{ $sale['user'] ? $sale['user']['name']  . ($sale['user']->trashed() ? ' (Deleted User)' : '') : 'Deleted User'}}</td>

                            {{-- <td>{{$sale['pieces']}}</td> --}}
                            <td>{{'KSh. '.number_format($sale['value'])}}</td>
                            </tr>
                            @endforeach
                            @else
                            <!--let datatables display no data available-->
                            <tr>
                                <td colspan="4" style="text-align: center">No sales so far</td>
                            </tr>
                            @endif

                            {{-- Add empty rows if necessary --}}
                            @for($i = 0; $i < $differenceOutletsSales && 
                            $salesTableCount < $outletsTableCount; $i++)
                            <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Recent Outlets</h3>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table border text-nowrap text-md-nowrap table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            <!--let datatables display no data available-->
                            <tr>
                                <td colspan="4" style="text-align: center">No outlets so far</td>
                            </tr>
                            @endif

                            {{-- Add empty rows if necessary --}}
                            @for($i = 0; $i < $differenceOutletsSales && 
                            $outletsTableCount < $salesTableCount; $i++)
                            <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
    ...
    @php
    // Determine the row counts
    $productCount = count($topProducts) > 0 ? count($topProducts) : 1;
    $outletCount = count($topOutlets) > 0 ? count($topOutlets) : 1;
    // Calculate the difference
    $difference = abs($productCount - $outletCount);
    @endphp
    ...
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table border text-nowrap text-md-nowrap table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                {{-- <td>{{$topSeller['user']['id']}}</td> --}}
                                <td>{{$topProduct['name']}}</td>
                                {{-- <td>{{$topProduct['sku']}}</td> --}}
                                <td>{{number_format($topProduct['total_quantity'])}}</td>
                                </tr>
                                @endforeach
                                @else
                                <!--let datatables display no data available-->
                                <tr>
                                    <td colspan="4" style="text-align: center">No sellers so far</td>
                                </tr>
                                @endif

                                {{-- Add empty rows if necessary --}}
                                @for($i = 0; $i < $difference && $productCount < $outletCount; $i++)
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Top Outlets</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table border text-nowrap text-md-nowrap table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                @foreach($topOutlets as $topOutlet)
                                <tr>
                                {{-- <td>{{$topOutlet['outlet']['id']}}</td> --}}
                                <td>{{$topOutlet['outlet']['name']}}</td>
                                <td>{{$topOutlet['outlet']['contact_person_name']}}</td>
                                <td>{{$topOutlet['count']}}</td>
                                </tr>
                                @endforeach
                                @else
                                <!--let datatables display no data available-->
                                <tr>
                                    <td colspan="4" style="text-align: center">No customers so far</td>
                                </tr>
                                @endif

                                {{-- Add empty rows if necessary --}}
                                @for($i = 0; $i < $difference && $outletCount < $productCount; $i++)
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
    ...
    <!-- ROW-3 -->
    {{-- // SALES REPORT BY LOCATION TEMPORARILY SUSPENDED --}}
    {{-- <div class="row">
        ...
        {{-- <div class="col-xl-6 col-lg-6 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title fw-semibold">More Analytics</h4>
                </div>
                <div class="card-body">
                    <div class="browser-stats">
                        <div class="row mb-4">
                            <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                <img src="../assets/images/dashboard/document-icon.svg" class="img-fluid"
                                    alt="img">
                            </div>
                            <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                <div class="d-flex align-items-end justify-content-between mb-1">
                                    <h6 class="mb-1">POS Audits</h6>
                                    <h6 class="fw-semibold mb-1">{{$posauditsCount}} <span
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                <img src="../assets/images/dashboard/people-icon.svg" class="img-fluid"
                                    alt="img">
                            </div>
                            <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                <div class="d-flex align-items-end justify-content-between mb-1">
                                    <h6 class="mb-1">Competitive Analysis</h6>
                                    <h6 class="fw-semibold mb-1">{{$competitorsCount}} <span
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                <img src="../assets/images/dashboard/comment-icon.svg" class="img-fluid"
                                    alt="img">
                            </div>
                            <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                <div class="d-flex align-items-end justify-content-between mb-1">
                                    <h6 class="mb-1">Feedback</h6>
                                    <h6 class="fw-semibold mb-1">{{$feedbackCount}} <span
                                            class="text-success fs-11">(<i
