...
<div class="sticky">
        ...
        <div class="main-sidemenu">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="side1">
                                    <ul class="sidemenu-list">
                                        ...
                                        <li><a href="/allocateoutletstousers" class="slide-item"> Allocate Outlets to Sellers</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                        ...
                        class="side-menu__label">Products & Services</span><i
                        class="angle fe fe-chevron-right"></i>
                </a>
                <ul class="slide-menu">
                    <li class="panel sidetab-menu">
                        ...
                        <div class="panel-body tabs-menu-body p-0 border-0">
                            <div class="tab-content">
                                <div class="tab-pane active" id="side1">
                                    <ul class="sidemenu-list">
                                        <li class="side-menu-label1"><a href="javascript:void(0)">Products & Services</a></li>
                                        <li><a href="/products" class="slide-item">Products</a></li>
                                        <li><a href="/services" class="slide-item">Services</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                        ...
                        class="side-menu__label">Outlets</span><i
                        class="angle fe fe-chevron-right"></i>
                </a>
                <ul class="slide-menu">
                    <li class="panel sidetab-menu">
                        ...
                        <div class="panel-body tabs-menu-body p-0 border-0">
                            <div class="tab-content">
                                <div class="tab-pane active" id="side1">
                                    <ul class="sidemenu-list">
                                        <li class="side-menu-label1"><a href="javascript:void(0)">Outlets</a></li>
                                        <li><a href="/outlets" class="slide-item">Outlets List</a></li>
                                        <li><a href="/showoutletsmap" class="slide-item">Outlets Map</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                        class="side-menu__icon fe fe-arrow-right-circle"></i><span
                        class="side-menu__label">Clockins</span><i
                        class="angle fe fe-chevron-right"></i>
                </a>
                <ul class="slide-menu">
                    <li class="panel sidetab-menu">
                        ...
                        <div class="panel-body tabs-menu-body p-0 border-0">
                            <div class="tab-content">
                                <div class="tab-pane active" id="side1">
                                    <ul class="sidemenu-list">
                                        <li class="side-menu-label1"><a href="javascript:void(0)">Clockins</a></li>
                                        <li><a href="/clockins" class="slide-item">Clockins List</a></li>
                                        <li><a href="/clockinsmap" class="slide-item">Clockins Map</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                        class="side-menu__icon fe fe-arrow-left-circle"></i><span
                        class="side-menu__label">Clockouts</span><i
                        class="angle fe fe-chevron-right"></i>
                </a>
                <ul class="slide-menu">
                    <li class="panel sidetab-menu">
                        ...
                        <div class="panel-body tabs-menu-body p-0 border-0">
                            <div class="tab-content">
                                <div class="tab-pane active" id="side1">
                                    <ul class="sidemenu-list">
                                        <li class="side-menu-label1"><a href="javascript:void(0)">Clockouts</a></li>
                                        <li><a href="/clockouts" class="slide-item">Clockouts List</a></li>
                                        <li><a href="/clockoutsmap" class="slide-item">Clockouts Map</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                        ...
                        class="side-menu__label">Outlet Visits</span><i
                        class="angle fe fe-chevron-right"></i>
                </a>
                <ul class="slide-menu">
                    <li class="panel sidetab-menu">
                        ...
                        <div class="panel-body tabs-menu-body p-0 border-0">
                            <div class="tab-content">
                                <div class="tab-pane active" id="side1">
                                    <ul class="sidemenu-list">
                                        <li class="side-menu-label1"><a href="javascript:void(0)">Outlet Visits</a></li>
                                        <li><a href="/visits" class="slide-item">Visits List</a></li>
                                        <li><a href="/visitsmap" class="slide-item">Visits Map</a></li>
                                        <li><a href="/dayroutes" class="slide-item">Day Routes</a></li>
                                        <li><a href="/visitsanalytics" class="slide-item">Visits Analytics</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <li class="slide">
                <a class="side-menu__item has-link" data-bs-toggle="slide" href="/routeplans"><i
                        class="side-menu__icon fe fe-map"></i><span
                        class="side-menu__label">Route Plans</span></a>
            </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="side1">
                                    <ul class="sidemenu-list">
                                        ...
                                        <li><a href="/sales" class="slide-item">Sales List</a></li>
                                        <li><a href="/salesmap" class="slide-item">Sales Map</a></li>
                                        <li><a href="/salesanalytics" class="slide-item">Sales Analytics</a></li>
                                        <li><a href="/salestargets" class="slide-item">Sales Targets</a></li>
          ...
          <li class="slide">
            <a class="side-menu__item has-link" data-bs-toggle="slide" href="/posaudits"><i
                    class="side-menu__icon fe fe-search"></i><span
                    class="side-menu__label">POS Audits</span></a>
        </li>
        <li class="slide">
          <a class="side-menu__item has-link" data-bs-toggle="slide" href="/competitors"><i
                  class="side-menu__icon fe fe-sidebar"></i><span
                  class="side-menu__label">Competitor Analysis</span></a>
      </li>
      <li class="slide">
        <a class="side-menu__item has-link" data-bs-toggle="slide" href="/feedback"><i
                class="side-menu__icon fe fe-rotate-ccw"></i><span
                class="side-menu__label">Feedback</span></a>
    </li>
    <li class="slide">
        <a class="side-menu__item has-link" data-bs-toggle="slide" href="/outofred"><i
                class="side-menu__icon fe fe-alert-circle"></i><span
                class="side-menu__label">Out of red</span></a>
    </li>
    ...
    <li class="slide">
        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                ...
                class="side-menu__label">Stock</span><i
                class="angle fe fe-chevron-right"></i>
        </a>
        <ul class="slide-menu">
            <li class="panel sidetab-menu">
                ...
                <div class="panel-body tabs-menu-body p-0 border-0">
                    <div class="tab-content">
                        <div class="tab-pane active" id="side1">
                            <ul class="sidemenu-list">
                                <li class="side-menu-label1"><a href="javascript:void(0)">Stock</a></li>
                                <li><a href="/stock" class="slide-item">Stock List</a></li>
                                <li><a href="/uploadstockchart" class="slide-item"> Upload Stock Chart</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
