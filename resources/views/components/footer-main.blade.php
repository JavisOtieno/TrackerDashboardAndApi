    ...
    <div class="container">
        <div class="row align-items-center flex-row-reverse">
            <div class="col-md-12 col-sm-12 text-center">
                Copyright © <span id="year"></span> <a href="javascript:void(0)">RTMS</a>. Designed <!--with <span
                    class="fa fa-heart text-danger">--></span> by <a href="https://www.scgafrica.com/"> Stan Consulting Group </a> All rights reserved.
            </div>
        </div>
    </div>
</footer>
...
<script src="{{asset('assets/js/index1.js')}}"></script>
    ...
    <script>
        function deleteItemDefault(id,name,name2,item){
            //alert(id);
            var itemDetails = document.getElementById("itemDetails");
            itemDetails.innerHTML = "Id: "+id+"<br/> Outlet Name: "+name+"<br/> Sales Rep Name: "+name2;
            var confirmDeleteLink = document.getElementById('confirmDelete'); //or grab it by tagname etc
            if(item=="posaudits"){
                confirmDeleteLink.href = "/deleteposaudits/"+id;
            }else if(item=="competitoranalysis"){
                confirmDeleteLink.href = "/deletecompetitiveanalysis/"+id;
            }else if(item=="feedback"){
                confirmDeleteLink.href = "/deletefeedback/"+id;
            }else if(item=="outofred"){
                confirmDeleteLink.href = "/deleteoutofred/"+id;
            }
