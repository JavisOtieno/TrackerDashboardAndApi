            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a type="button" href="/add-customer" class="btn btn-danger col-md-3" style="margin-left: auto;margin-right:20px;margin-top:10px;margin-bottom:10px;color:white;">Add Customer</a>
                        ...
                        <div class="table-responsive">
                            <table id="responsive-datatable" class="table table-bordered text-nowrap border-bottom">
                                ...
                                <tbody>
                                        ...
                                        <td>{{$user['id']}}</td>
                                        <td>
                                            <a type="button" href="/editcustomer/{{$user['id']}}" class="btn btn-info" style="margin-left: auto;color:white;">View/Edit</a>
                                        </td>
                                        <td><a type="button" onclick="deleteItem({{$user['id']}},'Id: '+{{$user['id']}}+'<br/> Name: '+'{{$user['name']}}'+'<br/> Phone: '+'{{$user['phone']}}'+'<br/> Email: '+'{{$user['email']}}')"  
                                            ...
                                            data-bs-toggle="modal" href="#modalDelete">Delete</a>
                                        </td>
                                        @if(auth()->user()->usertype == 'systemadmin')
...
<script>
    function deleteItem(id,message){
        ...
        confirmDeleteLink.href = "/deletecustomer/"+id;
    }
  </script>
