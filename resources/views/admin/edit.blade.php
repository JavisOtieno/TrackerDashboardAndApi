    ...
    <div class="card col-md-8">
        ...
        <div class="card-body">
            <!--<p>Use <code class="highlighter-rouge">.table-striped</code>to add zebra-striping to any table row within the <code class="highlighter-rouge">.tbody</code>.</p>-->
                    ...
                    <form action="/saveeditadmin/{{$user['id']}}" method="POST"  enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="">
                            @if ($errors->any())
                        ...
                            @endif
                            ...
                            <div class="form-group">
                                ...
                                <a href="/changepassword/admin/{{$user['id']}}" class="col-12 btn btn-info mb-0">Change Password</a>                            
                            </div>
