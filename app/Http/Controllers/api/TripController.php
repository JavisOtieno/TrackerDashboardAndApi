...
class TripController extends CommonController
{
    ...
    public function index(){
        ...
        $trips = Trip::with('customer')->where('user_id', $userid)->orderBy('created_at', 'desc')->get();
    ...
    public function indexCustomer(){
        ...
        $trips = Trip::where('customer_id', $userid)->where('status','!=', 'order')
    ...
    public function indexCustomerOrders(){

        $userid = auth()->user()->id;

        $trips = Trip::where('customer_id',  $userid)->where('status', 'order')->orderBy('created_at', 'desc')->get();
